...
try {
  ...
  const requiredTables = ['organizations', 'users', 'sessions', 'login_rate_limits', 'employees', 'departments', 'leave_types', 'leave_requests', 'leave_balances', 'attendance_records', 'audit_logs', 'organization_settings', 'platform_administrators', 'platform_audit_logs'];
